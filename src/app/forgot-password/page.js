        ...
        <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-xl p-6 sm:p-8 border border-gray-100 dark:border-gray-700 transition-colors duration-200">
          {!success ? (
            ...
            <div className="space-y-6">
              ...
              <Link
                href="/login"
                className="block w-full text-center rounded-lg bg-blue-600 hover:bg-blue-700 text-white font-semibold py-3 px-4 transition-[colors,shadow,transform] duration-200 shadow-sm hover:shadow hover:-translate-y-0.5"
              >
                Back to Login
              </Link>
            </div>
