          ...
          <div className="mt-6">
            <div className="relative">
              ...
              <div className="relative flex justify-center text-sm">
                <span className="px-2 bg-white dark:bg-gray-800 text-gray-500 dark:text-gray-400 transition-colors duration-200">Don't have an account?</span>
              </div>
            </div>
            ...
            <div className="mt-6 text-center">
              <Link
                href="/signup"
                className="text-blue-600 dark:text-blue-400 hover:text-blue-700 dark:hover:text-blue-300 font-medium text-sm sm:text-base transition-colors duration-200"
              >
            ...
            <div className="mt-4 text-center">
              <Link
                ...
                className="text-gray-600 dark:text-gray-400 hover:text-gray-700 dark:hover:text-gray-300 font-medium text-sm sm:text-base transition-colors duration-200"
              >
